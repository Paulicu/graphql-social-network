...
const searchResolvers = {
    Query: {
        search: async (_, { contains }, { dataSources }) => {
            ...
            let exerciseResults = [];
            if (!articleResults.length && !workoutResults.length && !programResults.length) {

                exerciseResults = await dataSources.exercisesAPI.getExercisesByName(contains);
            }
